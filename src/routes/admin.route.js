...
import { getUserSubscriptions ,getUsers,getUsersById } from "../controllers/admin.controller.js";
...
router.get("/users/:id/transactions",protectRoute,requireAdmin,getUsersById);
